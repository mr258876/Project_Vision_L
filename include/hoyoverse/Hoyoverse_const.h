...
const PROGMEM char *Hoyoverse_App_version[] = {"2.43.1", "2.25.0"};
const PROGMEM char *Hoyoverse_App_UA[] = {
    "Mozilla/5.0 (FreeRTOS; The Vision L; Espressif ESP32) AppleWebKit/605.1.15 (KHTML, like Gecko) miHoYoBBS/2.43.1",
    "Mozilla/5.0 (FreeRTOS; The Vision L; Espressif ESP32) AppleWebKit/605.1.15 (KHTML, like Gecko) miHoYoBBSOversea/2.25.0"};
