...
def convert():
    logging.basicConfig(level=logging.INFO)
    FILES_TO_CONVERT = [
        ["ui_img_back.png", ColorFormat.I2],
        ["ui_img_clock_horoscope03.png", ColorFormat.RGB565A8],
        ["ui_img_clock_horoscope04.png", ColorFormat.RGB565A8],
        ["ui_img_clock_horoscope05.png", ColorFormat.RGB565A8],
        ["ui_img_clock_horoscope06.png", ColorFormat.RGB565A8],
        ["ui_img_clock_horoscopeBg.png", ColorFormat.RGB565],
        ["ui_img_clock_mask.png", ColorFormat.RGB565A8],
        ["ui_img_clock_hourhand.png", ColorFormat.RGB565A8],
        ["ui_img_clock_minutehand.png", ColorFormat.RGB565A8],
        ["ui_img_clock_secondhand.png", ColorFormat.RGB565A8],
        ["ui_img_clockicon_dusk.png", ColorFormat.RGB565A8],
        ["ui_img_clockicon_morning.png", ColorFormat.RGB565A8],
        ["ui_img_clockicon_night.png", ColorFormat.RGB565A8],
        ["ui_img_clockicon_noon.png", ColorFormat.RGB565A8],
        ["ui_img_menu_clock.png", ColorFormat.I4],
        ["ui_img_menu_element.png", ColorFormat.I4],
        ["ui_img_menu_resin.png", ColorFormat.I4],
        ["ui_img_menu_setting.png", ColorFormat.I4],
        ["ui_img_resin_expeditions.png", ColorFormat.I8],
        ["ui_img_resin_homecoin.png", ColorFormat.I8],
        ["ui_img_resin_resin.png", ColorFormat.I8],
        ["ui_img_resin_transformer.png", ColorFormat.I8],
        ["ui_img_weather_clear_sky.png", ColorFormat.I2],
        ["ui_img_weather_fog.png", ColorFormat.I2],
        ["ui_img_weather_freezing_drizzle.png", ColorFormat.I2],
        ["ui_img_weather_hail.png", ColorFormat.I2],
        ["ui_img_weather_haze.png", ColorFormat.I2],
        ["ui_img_weather_heavy_rain.png", ColorFormat.I2],
        ["ui_img_weather_heavy_snow_fall.png", ColorFormat.I2],
        ["ui_img_weather_moderate_rain.png", ColorFormat.I2],
        ["ui_img_weather_moderate_snow_fall.png", ColorFormat.I2],
        ["ui_img_weather_overcast.png", ColorFormat.I2],
        ["ui_img_weather_partly_cloudy.png", ColorFormat.I2],
        ["ui_img_weather_rain_showers.png", ColorFormat.I2],
        ["ui_img_weather_rainstorm.png", ColorFormat.I2],
        ["ui_img_weather_sand.png", ColorFormat.I2],
        ["ui_img_weather_sandstorm.png", ColorFormat.I2],
        ["ui_img_weather_sleet.png", ColorFormat.I2],
        ["ui_img_weather_slight_rain.png", ColorFormat.I2],
        ["ui_img_weather_slight_snow_fall.png", ColorFormat.I2],
        ["ui_img_weather_snow_showers.png", ColorFormat.I2],
        ["ui_img_weather_snowstorm.png", ColorFormat.I2],
        ["ui_img_weather_thunderstorm.png", ColorFormat.I2],
    ]

    for file in FILES_TO_CONVERT:
        img = LVGLImage().from_png(f".assets/{file[0]}", cf=file[1], background=0x00_00_00)
        img.to_c_array(f"src/assets/{file[0].replace('.png', '.c')}")
